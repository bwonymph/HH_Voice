...
// Created account is preloaded with 1 HBAR, may need more for additional interactions with Hedera Hashgraph.
// For more information or usage of Open Waters and the Armada Platform, contact kent@armadachain.io. 
...
const createAccount = async () => {
  ...
  console.log("You can insert this in voice.js to send messages without creating new topics")
}
...
run().then(() => console.log('Sent. Your voice has been added to Hedera Hashgraph!'))